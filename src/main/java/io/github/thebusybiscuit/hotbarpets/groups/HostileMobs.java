...
public final class HostileMobs implements PetGroup {
    ...
    public void load(HotbarPets plugin) {
        // @formatter:off
        new SpiderPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_SPIDER", PetTexture.SPIDER_PET.getHash(), "&8Spider Pet", getName(), "&7Favourite Food: Rotten Flesh", "", "&fRight-Click: &7Gives you JUMP_BOOST Boost"), new ItemStack(Material.ROTTEN_FLESH), new ItemStack[]{
                ...
                new ItemStack(Material.STRING), HotbarPets.convert(SlimefunItems.GOLD_16K), new ItemStack(Material.STRING)
        }).register(plugin);
        ...
        new GhastPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_GHAST", PetTexture.GHAST_PET.getHash(), "&fGhast Pet", getName(), "&7Favourite Food: Fire Charge", "", "&fRight-Click: &7Launches Fireballs"), new ItemStack(Material.FIRE_CHARGE), new ItemStack[]{
                ...
                HotbarPets.convert(SlimefunItems.GOLD_24K), new ItemStack(Material.TNT), HotbarPets.convert(SlimefunItems.GOLD_24K)
        }).register(plugin);
        ...
        new PhantomPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_PHANTOM", PetTexture.PHANTOM_PET.getHash(), "&7Phantom Pet", getName(), "&7Favourite Food: Beetroot", "", "&fRight-Click: &7Gives SLOWNESS Falling"), new ItemStack(Material.BEETROOT), new ItemStack[]{
                new ItemStack(Material.PHANTOM_MEMBRANE), new ItemStack(Material.RABBIT_FOOT), new ItemStack(Material.PHANTOM_MEMBRANE),
                new ItemStack(Material.DIAMOND), HotbarPets.convert(SlimefunItems.GOLD_6K), new ItemStack(Material.DIAMOND),
                new ItemStack(Material.PHANTOM_MEMBRANE), new ItemStack(Material.RABBIT_FOOT), new ItemStack(Material.PHANTOM_MEMBRANE)
        }).register(plugin);
        ...
        new EndermanPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_ENDER_MAN", PetTexture.ENDERMAN_PET.getHash(), "&8Enderman Pet", getName(), "&7Favourite Food: End Stone", "", "&fRight-Click: &7Shoots an Ender Pearl"), new ItemStack(Material.END_STONE), new ItemStack[]{
                ...
                new ItemStack(Material.ENDER_PEARL), HotbarPets.convert(SlimefunItems.GOLD_16K), new ItemStack(Material.ENDER_PEARL)
        }).register(plugin);
        ...
        new CreeperPet(plugin, new SlimefunItemStack("HOTBAR_PET_CREEPER", Material.CREEPER_HEAD, "&2Creeper Pet", getName(), "&7Favourite Food: Gunpowder", "", "&fImmune to Explosions", "&fRight-Click: &7Explode"), new ItemStack(Material.GUNPOWDER), new ItemStack[]{
                ...
                new ItemStack(Material.DIAMOND), HotbarPets.convert(SlimefunItems.GOLD_20K), new ItemStack(Material.DIAMOND)
        }).register(plugin);
        ...
        new HotbarPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_MAGMA_CUBE", PetTexture.MAGMA_CUBE_PET.getHash(), "&4Magma Cube Pet", getName(), "&7Favourite Food: Nether Quartz", "", "&fImmune to Lava", "&fQuite hungry"), new ItemStack(Material.QUARTZ), new ItemStack[]{
                ...
                new ItemStack(Material.NETHERRACK), HotbarPets.convert(SlimefunItems.GOLD_20K), new ItemStack(Material.NETHERRACK)
        }).register(plugin);
        ...
        new HotbarPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_ZOMBIE", Material.ZOMBIE_HEAD, "&2Zombie Pet", getName(), "", "&fAllows you to eat Rotten Flesh", "&fwithout getting Hunger"), new ItemStack(Material.ROTTEN_FLESH), new ItemStack[] {
                ...
                new ItemStack(Material.ROTTEN_FLESH), HotbarPets.convert(SlimefunItems.NECROTIC_SKULL), new ItemStack(Material.ROTTEN_FLESH)
        }).register(plugin);
        // @formatter:on
    }
}
