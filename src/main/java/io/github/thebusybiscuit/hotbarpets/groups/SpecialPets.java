...
public final class SpecialPets implements PetGroup {
    ...
    public void load(HotbarPets plugin) {
        ...
        new PatriotPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_PATRIOT", PetTexture.PATRIOT_PET.getHash(), "&5Patriot Pet", getName(), "&7Favourite Food: Nether Wart", "", "&fGives Resistance, Regeneration, Strength, ", "&fand Saturation"), new ItemStack(Material.NETHER_WART), new ItemStack[] {
                new ItemStack(Material.REDSTONE), HotbarPets.convert(SlimefunItems.MAGIC_LUMP_1), new ItemStack(Material.REDSTONE),
                HotbarPets.convert(SlimefunItems.MAGIC_LUMP_1), HotbarPets.convert(SlimefunItems.RAW_CARBONADO), HotbarPets.convert(SlimefunItems.MAGIC_LUMP_1),
                HotbarPets.convert(SlimefunItems.GOLD_4K), new ItemStack(Material.REDSTONE), HotbarPets.convert(SlimefunItems.GOLD_4K)
        }).register(plugin);
